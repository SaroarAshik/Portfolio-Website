                            ...
                            <div style="height: 450px" class="col-md-6 p-3">
                                <form  action=" "  class="m-5 loginForm">
                                        <div class="form-group">
                                            ...
                                            <input required="" name="userName" value="" type="text" class="form-control" 
...
<script type="text/javascript">
    ...
    $('.loginForm').on('submit',function (event) {
            ...
            //when we call serialized method The form values ​​will come in the form of an array 
            //and serialize method seriaze (name and value) 
